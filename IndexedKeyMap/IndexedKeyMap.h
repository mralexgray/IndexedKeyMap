...
Subscriptable...
*/
@interface IndexedKeyMap : NSObject <KeySubs, IndexSubs, NSFastEnumeration>

@PROP_READ NSUInteger count;

- (void)           add:(id)smart;
- (void)     addObject:(id)x forKey:(id)k;
- (void)     addObject:(id)x;
- (void)  removeObject:(id)x;
- (void)    addObjects:(NSArray*)x;
- (void) removeObjects:(NSArray*)x;

@PROP_READ NSArray *allKeys, *allValues;
@PROP_READ      id JSONRepresentation;
@PROP_NATM      id primaryKey, primaryValue;
